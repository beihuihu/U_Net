...
class DataGenerator():
    ...
    """
    def __init__(self, input_size,output_size, frames, augmenter=None):
    ...
    def all_sequential_patches(self, step_size):
        ...
        for frame in self.frames:
            ips,aps= frame.sequential_patches(self.input_size,self.output_size, step_size)
    ...
    def random_patch(self, BATCH_SIZE,percentages):
        ...
        for i in range(BATCH_SIZE):
            ...
            img_patch, ann_patch = frame.random_patch(self.input_size,self.output_size)

...
#         self.trained_model_path = r'/home/nkd/hbh/saved_models/lakes_20240101-2240_AdaDelta_dice_loss_012345_576.h5'
        ...
        self.output_prefix = 'predition_b5_572_'  
        ...
        self.WIDTH=572 # Should be same as the WIDTH used for training the model
        self.HEIGHT=572 # Should be same as the HEIGHT used for training the model
        self.STRIDE=388 # STRIDE = WIDTH   means no overlap；  STRIDE = WIDTH/2   means 50 % overlap in prediction 
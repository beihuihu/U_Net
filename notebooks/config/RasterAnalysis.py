...
class Configuration:
    ...
    def __init__(self):
        ...
        self.input_image_dir = r'D:\sample250\test_img'
        self.input_image_type = '.tif'
        self.ndwi_fn_st =  'ndwi_int8'
        self.bands_fn_st =  'bands_int16'
        
#         self.input_image_dir = r'D:\sample250\test_png'
...
#         self.swir_fn_st = 'swir'
        ...
        self.trained_model_path = r'D:\sample250\U-Net_13\saved_models\UNet\lakes_20230818-2031_AdaDelta_dice_loss_b5_012345_512.h5'
#         self.trained_model_path = r'D:\sample250\U-Net_12\saved_models\UNet\lakes_20230818-2031_AdaDelta_dice_loss_b5_012345_512.h5'
        print('self.trained_model_path:', self.trained_model_path)
        
        self.output_image_type = '.tif'
        self.output_dir = r'D:\sample250\test_img\predition'
#         self.output_dir = r'D:\sample250\test_png\predition\padding'
        
        self.output_prefix = 'predition_'  

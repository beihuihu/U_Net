...
class Configuration:
    def __init__(self):
        ...
        self.dataset_dir=r'G:\5_lakemapping\sample635_12\patchesReshape'#os.path.join(self.base_dir,'patchesReshape')
...
#         self.dataset_dir=r'/media/nkd/backup/5_lakemapping/sample600/patchesReshape'
        ...
        self.VALID_IMG_COUNT = 139      
        # maximum number of steps_per_epoch in training
        self.MAX_TRAIN_STEPS = 435 #steps_per_epoch=(num_train/batch_size)
